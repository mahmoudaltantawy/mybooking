...
@Component({
  selector: 'app-hotel-travellers-data',
  templateUrl: './hotel-travellers-data.component.html',
  styleUrls: ['./hotel-travellers-data.component.scss']
})
export class HotelTravellersDataComponent implements OnInit {
